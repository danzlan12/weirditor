            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item ms-5"><a class="nav-link" href="#!">Portofolio</a></li>
                        <li class="nav-item ms-5"><a class="nav-link" href="#!">About Us</a></li>
                        <li class="nav-item ms-5"><a class="nav-link" href="#!">Contact</a></li>
                    </ul>
                </div>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-black mb-2">Hello ©  مرحبًا</h1>
                            <p class="lead text-black-50 mb-4">こんにちは ✱ Bonjour </p>
